import type { DailyRoutineRunOptions } from '@/modules/account/application/runner/account-runner'
import type { GameConfigService } from '@/modules/game/application/game-config.service'
import type { FertilizerBuyConfig } from '@/modules/game/domain/constants'
...
import { getDateKey, getRewardSummary } from '@/modules/game/domain/utils'
...
export class DailyRewardsWorker {
  ...
  async autoBuyFertilizer(config: FertilizerBuyConfig, force = false): Promise<number> {
