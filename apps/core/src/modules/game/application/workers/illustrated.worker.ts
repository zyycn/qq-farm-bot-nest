import type { GameConfigService, ItemInfo, PlantInfo } from '@/modules/game/application/game-config.service'
...
import { getRewardSummary, toNum } from '@/modules/game/domain/utils'
