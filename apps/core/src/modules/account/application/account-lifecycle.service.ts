...
import type { RunningAccount } from '@/modules/account/application/account-registry.service'
import type { AccountReconnectRequestPayload } from '@/modules/account/domain/account.events'
import type { LinkEventName, LinkUserState } from '@/modules/game/domain/types'
import { Injectable, Logger } from '@nestjs/common'
import { EventEmitter2, OnEvent } from '@nestjs/event-emitter'
import { AccountLifecycleLinkOps } from '@/modules/account/application/account-lifecycle-link'
import { AccountRegistryService } from '@/modules/account/application/account-registry.service'
import { AccountRunnerFactory } from '@/modules/account/application/runner/account-runner.factory'
import {
...
export class AccountLifecycleService implements OnModuleInit, OnModuleDestroy {
  ...
  async handleReconnectRequest(payload: AccountReconnectRequestPayload) {
    await this.reconnectAccounts(payload.accountIds || [])
  }
