...
import type { AccountLifecycleService } from '@/modules/account/application/account-lifecycle.service'
...
import type { GamePushService } from '@/modules/game/application/game-push.service'
import type { ConnectionEventData, ProfileEventData, StatusEventData } from '@/modules/game/domain/types'
