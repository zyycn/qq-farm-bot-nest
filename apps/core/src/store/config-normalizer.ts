import type { AccountConfigSnapshot, AutomationConfig, FertilizerBuyConfig, FertilizerLandType, FertilizerMode, IntervalsConfig, OfflineReminderConfig, PlantingStrategy } from '../game/constants'
